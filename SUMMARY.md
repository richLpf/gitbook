...
* [日常整理](unknown/README.md)
    ...
    * [Mysql安装](unknow/days/mysql安装.md)
    * [Mysql和Mongo备份](mysql和mongo备份.md)
* [Nginx](unknow/nginx/README.md)
    *  [Nginx安装记录](unknow/nginx/Nginx安装记录.md)
    * [Nginx常用命令清单](unknow/nginx/Nginx常用命令清单.md)
    * [Nginx和Openssl升级](unknow/nginx/Nginx和Openssl升级.md)
    * [Nginx日志分析](unknow/nginx/Nginx日志分析.md)
    * [Nginx日志配置和处理](unknow/nginx/Nginx日志配置和处理.md)
* [Git](git/README.md)
    * [快速上手](git/快速上手.md)
    * [分支管理](git/分支管理.md)
    * [工作常见问题](git/常见操作.md)
